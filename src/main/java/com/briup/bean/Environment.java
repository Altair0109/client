...
/**
 * @Author: briup 环境存储实体类，包括环境种类(温度，湿度，二氧化碳，光照强度)
...
public class Environment implements Serializable {
	...
	/**
	 * 无参构造函数 全参构造函数 get,set方法 toString方法
	 */
	public Environment() {
	}
	...
	public Environment(String name, String srcId, String desId, String devId, String sersorAddress, int count,
			String cmd, float data, int status, Timestamp gather_date) {
		this.name = name;
		this.srcId = srcId;
		this.desId = desId;
		this.devId = devId;
	...
	public String toString() {
		return "Environment{" + "name='" + name + '\'' + ", srcId='" + srcId + '\'' + ", desId='" + desId + '\''
				+ ", devId='" + devId + '\'' + ", sersorAddress='" + sersorAddress + '\'' + ", count=" + count
				+ ", cmd='" + cmd + '\'' + ", data=" + data + ", status=" + status + ", gather_date=" + gather_date
				+ '}';
	}
}
